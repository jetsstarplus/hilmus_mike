(function ($) {
  ...
  var $progress = $('<div id="upload-progress" class="upload-progress"></div>')
    .appendTo(location)
    .append(
      '<div class="progress-container"><div class="progress-info"></div><div class="progress-bar"></div></div>'
    );
  ...
  form.submit((e) => {
    ...
    let options = {
      ...
      uploadProgress: function (event, position, total, percentComplete) {
        ...
        // console.log(width)
        var progress_width = percentComplete + "% of " + total + "Mb";
      ...
      statusCode: {
        ...
        500: function (responseObject, textStatus) {
          document.getElementById("sendmessage").classList.remove("show");
          document.getElementById("errormessage").innerHTML =
            "Internal Server 500!" + " " + textStatus;
          document.getElementById("errormessage").classList.add("show");
...
const resetForm = () => {
  document.getElementById("sendmessage").classList.remove("show");
  document.getElementById("errormessage").classList.remove("show");
  document.getElementsByClassName("progress-bar").width(0);
  document.getElementsByClassName("progress-info").innerHTML = "";
